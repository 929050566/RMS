	...
	<body>
		<div id="m">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" id="m">
			  <tr>
				<td nowrap class="title1">销售管理 -- 销售了结</td>
			  </tr>
			</table>
			...
			<script type="text/javascript">
				function fun1(){
					location.href="SaleManageServlet?option=saleEnd&paystateToQuery=1";
				}
				function fun2(){
					location.href="SaleManageServlet?option=saleEnd&paystateToQuery=2";
				}
				function fun3(){
					location.href="SaleManageServlet?option=saleEnd&paystateToQuery=3";
				}
			</script>
			<div id="dataList">
				<table width="100%" border="0" align="center" cellspacing="1" class="c">
					...
					<tr>
						...
						<td align="center">
							<a href="SaleManageServlet?option=setEnd&paystateToQuery=${paystateToQuery }&saleid=${sale.saleid}" onclick="return confirmSubmit();">了结</a>
						</td>
						<script type="text/javascript">
				...
				<div class="pageDiv">
					当前第<span id="currentPage">${page }</span>页
						<a id="start" style="font-size: large;" href="SaleManageServlet?option=saleEnd&paystateToQuery=${paystateToQuery }&page=1" >首页</a>
						<a id="last"  style="font-size: large;" href="SaleManageServlet?option=saleEnd&paystateToQuery=${paystateToQuery }&page=${page - 1 }">上一页</a>
						<a id="next"  style="font-size: large;" href="SaleManageServlet?option=saleEnd&paystateToQuery=${paystateToQuery }&page=${page + 1 }">下一页</a>
						<a id="end"   style="font-size: large;" href="SaleManageServlet?option=saleEnd&paystateToQuery=${paystateToQuery }&page=${totalPage }">末页</a>
