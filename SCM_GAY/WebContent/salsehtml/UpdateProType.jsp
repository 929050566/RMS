...
<body onload="init()">
		...
		<table width="100%"  border="0" cellpadding="0" cellspacing="0">
			<tr>
				...
				<td><input type="text" id="typename" name="typename" value="${protype.product_typename}" /></td>
			</tr>
			<tr>
				<td align="right">类别描述</td>
				<td><input type="text" id="typecom" name="typecom" value="${protype.product_typecomment}" /></td>
			</tr>
			<tr>
				<input type="hidden" id = "typeid" value="${protype.product_id}" />
			</tr> 
			<tr>
				<td align="right"><input type="button" value="修改"  id="addtypebutton" name="addtypebutton" onclick="updateType()"></td>
