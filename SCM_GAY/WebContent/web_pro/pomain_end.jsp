	...
	<body>
		<div id="m">
			...
			<script type="text/javascript">
				function fun1(){
					location.href="Purchase?option=pur_endAll&paystate=1";
				}
				function fun2(){
					location.href="Purchase?option=pur_endAll&paystate=2";
				}
				function fun3(){
					location.href="Purchase?option=pur_endAll&paystate=3";
				}
			</script>
			<div id="dataList">
				<table width="100%" border="0" align="center" cellspacing="1" class="c">
					...
					<tr>
						<td align="center"><a href="pomain_detail.html">${purchase.purchaseid }</a></td>
						...
						<td align="center">
							<a href="Purchase?option=purToEnd&purchaseid=${purchase.purchaseid }&paystate=${paystate}" onclick="return confirmSubmit();">了结</a>
						</td>
						<script type="text/javascript">
				...
				<div class="pageDiv">
					当前第<span id="currentPage">${page }</span>页
						<a id="start" style="font-size: large;" href="Purchase?option=pur_endAll&page=1" >首页</a>
						<a id="last"  style="font-size: large;" href="Purchase?option=pur_endAll&page=${page - 1 }">上一页</a>
						<a id="next"  style="font-size: large;" href="Purchase?option=pur_endAll&page=${page + 1 }">下一页</a>
						<a id="end"   style="font-size: large;" href="Purchase?option=pur_endAll&page=${totalPage }">末页</a>
