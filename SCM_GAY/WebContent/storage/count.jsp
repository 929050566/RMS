	...
	<body>
		<div id="m">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" id="m">
			  <tr>
				<td nowrap class="title1">库存管理 -- 库存盘点</td>
			  </tr>
			</table>
				...
				<table width="100%" border="0" align="center" cellspacing="1" class="c">
				 ...
				 <c:forEach items="${counts}" var="c">
                  <tr >
                    ...
                    <td align="center" colspan="2">${c.proName}</td>
                    <td align="center" colspan="2"><a href="type?option=gx&number=${c.presentNum}&proid=${c.proID}">${c.presentNum}(可修改)</a></td>
