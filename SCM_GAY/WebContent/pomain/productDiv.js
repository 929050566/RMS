...
function addItem() {
	...
	oCell.innerHTML = "<input type='text' id='sptj' size='10' name='pronum' value='0' onchange='changePrice(this)' >";
	oCell = oRow.insertCell(5);
	oCell.innerHTML = "<input type='text' id='spzl' size='10'  name='unitprice' value='0' onchange='changePrice(this)'>";
	oCell = oRow.insertCell(6);
	oCell.innerHTML = "<input type='text' id='stsl' size='10' value='0' name='totalprice' value='0'	 onchange='product()' readonly>";
