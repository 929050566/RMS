	...
	<body>
		<div id="m">
			<table width="100%"  border="0" cellpadding="0" cellspacing="0" id="m">
			  <tr>
				<td nowrap class="title1">业务报表 -- 月季出库报表</td>
			  </tr>
			</table>
			...
			<div id="dataList">
				<table width="100%" border="0" align="center" cellspacing="1" class="c">
					...
					<tr style="display:none"><td colspan="10" name="detail"></td></tr>
					<tr>
						<td class="title1" colspan="4">出库单据数</td>
						<td class="title1" colspan="3">产品总数量</td>
						<td class="title1" colspan="3">出库产品总金额</td>
					</tr>
				...
				<div id="dataList" style="margin-top:50">
					<table width="100%" border="0" align="center" cellspacing="1" class="c">
						<tr><td colspan="6" class="title1" >出库报表明细</td></tr>
						<tr>
				...
				<c:forEach items="${rlist}" var="c">
                  	...
                  	<tr >
						<td align="center">${c.salebillid}</td>
						<td align="center">${c.outStorageDate}</td>
